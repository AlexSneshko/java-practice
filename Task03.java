...
public class Task03 {
	public static void main(String[] args) {
		...
		if (depositAmount % 0.01 < 0.005)
			System.out.println(depositAmount - depositAmount % 0.01);
		else
			System.out.println((depositAmount - depositAmount % 0.01) - (depositAmount - depositAmount % 0.01) % 0.01 + 0.02);
	}
}